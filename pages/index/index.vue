  ...
  <view class="container">
    ...
    <view class="status-bar">
      ...
      <view class="header">
        ...
        <text class="version">v1.1.0 稳定版</text>
    ...
    <view class="vision-area">
      ...
      <view v-show="!isCameraRunning" class="loading-overlay">
        ...
        <view class="start-card">
          ...
          <text class="card-desc">点击激活摄像头进行手势识别</text>
    ...
    <view class="action-bar">
      ...
      <view class="debug-panel">
        ...
        <text class="debug-line">资源路径：{{ debugPath }}</text>

        <text class="debug-line">AI 状态：{{ isAIReady ? '在线' : '离线' }}</text>
    ...
    receiveMessage(data) {
      ...
      switch (data.type) {
        ...
        case 'error':
          ...
          uni.showModal({ title: '警告', content: data.content, showCancel: false });
