...
*/
    ...
    function lb(a) {
        ...
        if (a instanceof Uint8Array) return {buffer: new Uint8Array(a.buffer, a.byteOffset, a.byteLength), C: !1};
    ...
    var Y = Ac(function (a, b, c) {
        ...
        Dc = Ac(function (a, b, c) {
            ...
            if (db) {
                ...
                d = h + d;
                e = [];
                for (var k = null, l, m; h < d;) l = a[h++], 128 > l ? e.push(l) : 224 > l ? h >= d ? K() : (m = a[h++], 194 > l || 128 !== (m & 192) ? (h--, K()) :
            ...
            switch (p.h) {
                ...
                case 6:
                    ...
                    g = a.i.GL.createContext(a.m, {
                        antialias: !1,
                        alpha: !1, ua: "undefined" !== typeof WebGL2RenderingContext ? 2 : 1
                    });
                    ...
                    if ("detection_list" === r.type) {
                        if (p) {
                            ...
                            for (var J = p.getLandmarksList(),
                                ...
                                var T = Sc(B.get(C)), pd = W(T, 1), qd = W(T, 2), rd = W(T, 3), sd = W(T, 4),
                                    td = W(T, 5, 0), Aa = void 0;
                                Aa = void 0 === Aa ? 0 : Aa;
                                T = {
                                    la: {ra: pd, sa: qd, height: rd, width: sd, rotation: td, pa: Rb(S(T, 6), Aa)},
    ...
    function od(a) {
        ...
        this.h = new fd({
            ...
            files: function (c) {
                return [{url: "hands_solution_packed_assets_loader.js"}, {
                    simd: !1,
                    url: "hands_solution_wasm_bin.js"
                }, {simd: !0, url: "hands_solution_simd_wasm_bin.js"}, {data: !0, url: nd(c.modelComplexity)}]
            },
            ...
            listeners: [{
                ...
                outs: {
                    ...
                    multiHandedness: {
                        type: "proto_list", stream: "multi_handedness", transform: function (c) {
            ...
            options: {
                useCpuInference: {
                    ...
                    default: "object" !== typeof window || void 0 === window.navigator ? !1 : "iPad Simulator;iPhone Simulator;iPod Simulator;iPad;iPhone;iPod".split(";").includes(navigator.platform) ||
