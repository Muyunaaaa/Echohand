var createMediapipeSolutionsWasm = (() => {
    ...
    return (
        function (createMediapipeSolutionsWasm) {
            ...
            var ASM_CONSTS = {
                600868: $0 => {
                    ...
                    const bindGroup = device.createBindGroup({
                        layout: bgLayout,
                        entries: [{binding: 0, resource: sampler}, {binding: 1, resource: sourceExtTex}]
                    });
            ...
            var JsValStore = {
                values: {}, next_id: 1, add: function (js_val) {
                    var id;
                    do {
            ...
            function _wgpuDeviceCreateBindGroup(deviceId, descriptor) {
                ...
                function makeEntry(entryPtr) {
                    ...
                    if (bufferId) {
                        ...
                        var size = size_high === -1 && size_low === -1 ? undefined : (assert(size_high < 2097152), size_high * 4294967296 + size_low);
                        return {
                            "binding": binding,
                            "resource": {
